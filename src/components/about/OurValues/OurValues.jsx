...
export default function OurValues() {
  ...
  return (
    <section
      className="relative text-white py-8 md:py-20 px-6 overflow-hidden  md:h-[90vh] flex items-center justify-center"
    >
      <img
        src={value}
        alt="background"
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {values.map(({ title, text, icon }, index) => (
            ...
            >
              ...
              <h3 className="text-2xl text-lightColor font-medium mb-2">{title}</h3>
